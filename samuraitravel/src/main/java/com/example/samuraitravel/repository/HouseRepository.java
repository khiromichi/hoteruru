...
//	public Page<House> findByNameLikeOrAddressLike(String nameKeyword, String addressKeyword, Pageable pageable);//HouseControllerでエラーになるため残している
//	public Page<House> findByAddressLike(String area, Pageable pageable);//HouseControllerでエラーになるため残している
//	public Page<House> findByPriceLessThanEqual(Integer price, Pageable pageable);//HouseControllerでエラーになるため残している
}
